...
La puissance dégagée par la réaction est proportionnel
...
de l'eau:
\begin{equation*}
    n\ind{t,eau} = Q\ind{eau} \ /\  V\ind{m}^\ce{H20(l)}
\end{equation*}
avec $V\ind{m}^\ce{H20(l)} = 1,\liter\per\kilo\gram \times 18\,\gram\per\mole
...
\begin{align*}
    ...
    \Delta H\ind{m,eau} \times Q\ind{eau} \ /\  V\ind{m}^\ce{H20(l)} \\
