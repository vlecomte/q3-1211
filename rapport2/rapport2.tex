...
on impose que la sortie de \ce{NH3} soit égale la valeur entrée.
...
et le débit massique de \ce{NH3} à produire, en tonnes par jour.%
...
de plus d'eau dans le reformage secondaire. Mais, les hypothèses nous imposent de n'introduire de l'eau qu'au niveau du reformage primaire, la production de \ce{NH3} n'est donc plus possible à partir de cette température.
